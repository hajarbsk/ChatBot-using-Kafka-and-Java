...
public abstract class JavaFXHelper {
    ...
    public static void addItems(GridPane gridPane) {
        ...
        sendButton.setStyle("-fx-background-color: #F08080; -fx-text-fill: white; -fx-font-weight: bold;");
    ...
    public static GridPane createGridPane() {
        ...
        gridPane.setBackground(new Background(new BackgroundFill(Color.web("LIGHTPINK"), CornerRadii.EMPTY, Insets.EMPTY)));
        return gridPane;
    }
}
